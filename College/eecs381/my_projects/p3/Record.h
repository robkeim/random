...
// A record contains a unique ID number (assigned when the record is created),
// an integer rating, a title, and a name.  Only the title and rating
// can be modified once a record is created.
...
private:
	...
	// This declaration helps ensure that Record objects are unique
