...
leaving only the "Point" classes and functions for "plane sailing".
...
from assignment, not computation. To preserve some flexibility for changing the coordinate system,
Point is defined as a separate class from Point, although at this time they are closely related.
...
It can be constructed from two Points, two Points, or a Polar_vector. The angle 
