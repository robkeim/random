namespace MyShuttle.Data
{
    ...
    public class MyShuttleDataInitializer : DropCreateDatabaseIfModelChanges<MyShuttleContext>
    {
        ...
        protected override void Seed(MyShuttleContext context)
        {
        ...
        private static void CreateDefaultUser(MyShuttleContext context)
        {
            ...
            if (!(context.Users.Any(u => u.UserName == login)))
            {
                ...
                var user = new ApplicationUser { UserName = login, CarrierId = _DefaultCarrierId };
                manager.Create(user, password);
                manager.AddClaim(user.Id, new Claim("ManageStore", "Allowed"));
            }
        }
