...
function part1(input) {
    ...
    while (true) {
        ...
        if (match) {
            ...
            } else if (knownValues[match[1]]) {
                knownValues[match[2]] = knownValues[match[1]];
                instructions.splice(index, 1);
            }
...
function runPart1() {
    ...
    // Test NOT operator
    Utils.assertAreEqual(-2, part1('NOT 1 -> a'));
    Utils.assertAreEqual(-2, part1('NOT 1 -> b\nb -> a'));
    Utils.assertAreEqual(-2, part1('b -> a\nNOT 1 -> b'));
